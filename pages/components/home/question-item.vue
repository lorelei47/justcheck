<template>
	<view class="media-item view" v-if="questionItem.questionContent" @click="click">
		<view class="view flex-col">
			...
			<text class="media-title">{{questionItem.questionContent}}</text>
		</view>
		<view class="media-foot flex-row">
			<view class="media-info flex-row">
				...
				<text class="tag-icon" v-for="(item, index) in questionItem.questionTag"
					@click.stop="tagGo(item,$event)">{{item}}</text>
			</view>
			<view class="media-info flex-row">
